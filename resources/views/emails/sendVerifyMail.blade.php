        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="
                ...
                ">
              <p style="margin: 0">
                Klik button dibawah ini untuk membuat password dan mengaktivasi akun
              </p>
            </td>
          </tr>
          <!-- end copy -->
                ...
                <tr>
                  <td align="center" bgcolor="#ffffff" style="padding: 12px">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#34A853" style="border-radius: 6px">
                          <a href="{{route('verifyEmail',$user['id'])}}" target="_blank" style="
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="
                  ...
                  line-height: 24px;
                ">
              <p style="margin: 0">atau klik link dibawah ini:</p>
              <p style="margin: 0">
                <a href="{{route('verifyEmail',$user['id'])}}" target="_blank">{{route('verifyEmail',$user['id'])}}</a>
              </p>
            </td>
          </tr>
          <!-- end copy -->
